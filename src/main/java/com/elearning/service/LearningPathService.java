...
public class LearningPathService {
    ...
    public LearningPathDTO getLearningPathWithProgress(Long userId, Long pathId) {
        ...
        double progressPercentage = pathCourses.isEmpty() ? 0.0 : 
                (double) completedCourses / pathCourses.size() * 100;
    ...
    private void updateContentRecommendations(LearningPath path, LearningStyle learningStyle) {
        ...
        // This would involve filtering/reordering courses based on content type preferences
    }
