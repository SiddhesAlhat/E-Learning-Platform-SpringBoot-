...
public class CourseService {
    ...
    public CourseDetailDTO getCourseWithProgress(Long courseId, Long userId) {
        ...
        dto.setUserProgress(calculateProgress(userProgress));
    ...
    public LessonDTO addLessonToModule(Long moduleId, CreateLessonRequest request) {
    ...
    public CourseDTO updateCourse(Long courseId, CreateCourseRequest request, User instructor) {
        Course course = courseRepository.findById(courseId)
                .orElseThrow(() -> new RuntimeException("Course not found"));
